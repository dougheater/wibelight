...
int wiiu_proc_running(void)
{
    ...
    // Do NOT call ProcUIShutdown() here — it can block or deadlock
    // while streaming threads still hold GX2/audio/network resources.
    // The caller must call wiiu_proc_shutdown_procui() after cleanup.
